    ...
    <ul class="navbar-nav">
            ...
            <?php
                if ( isset($_SESSION['email']) )
                {
                    ...
                    if($_SESSION['userType']=='technicien'){
                        echo '<li class="nav-item">
                        <a class="nav-link" href="index.php?page=5">Rapports</a>
                    </li>';
                    }

                    if($_SESSION['userType']=='admin'){
                        echo '<li class="nav-item">
                        <a class="nav-link" href="index.php?page=6">Ajouter utilisateur</a>
                    </li>';
                    }
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">
                        ...
                        <div>
                            ...
                            <input type="radio" name="userType" id="userType" value="technicien">
                            <label for="technicien">Technicien</label><br>
